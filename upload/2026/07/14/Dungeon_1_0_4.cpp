...
vector<Skill> ALL_SKILLS = {
    ...
    {"冲刺", "向移动方向快速移动3/4/5格", ACTIVE, 0, 3, 3, 5, 3},            // 冷却3, 蓝耗5, 距离3+(1/2/3)
    {"烈焰风暴", "对周围5x5敌人造成伤害", ACTIVE, 0, 3, 5, 8, 1.0f},         // 伤害为攻击力 100%(+100%/200%/300%)
    {"治疗术", "回复最大生命百分比", ACTIVE, 0, 3, 7, 10, 0.15f},            // 基础回复15%(+3%/6%/9%)
    {"护盾", "获得可吸收伤害的护盾，持续5回合", ACTIVE, 0, 3, 10, 10, 0.2f}, // 吸收量=最大生命20%(+5%/10%/15%)
    {"狂暴", "临时增加攻击力，持续3回合", ACTIVE, 0, 3, 5, 7, 0.3f},         // 增加攻击力30%(+5%/10%/15%)
    {"铁壁", "临时增加防御力，持续3回合", ACTIVE, 0, 3, 5, 7, 0.3f},         // 增加防御力30%(+5%/10%/15%)
    {"冻结", "冻结视野内所有敌人", ACTIVE, 0, 3, 10, 10, 2},                 // 冻结 2+(1/2/3)回合
};
